...
namespace AxCrypt.Core.Test
{
    ...
    public static class TestExtensions
    {
        ...
        public static void TestExtensions_CreateEncryptedName()
        {
            ...
            string fileName = rootPath.PathCombine("Users", "AxCrypt", "A Documents Folder", "My Document.docx");
            string encryptedFileName = New<IDataStore>(fileName).CreateEncryptedName().FullName;
            Assert.That(encryptedFileName, Is.EqualTo(rootPath.PathCombine("Users", "AxCrypt", "A Documents Folder", "My Document-docx.axx")), "Standard conversion of file name to encrypted form.");
            ...
            fileName = rootPath.PathCombine("Users", "AxCrypt", "A Documents Folder", "My Extensionless File");
            encryptedFileName = New<IDataStore>(fileName).CreateEncryptedName().FullName;
            Assert.That(encryptedFileName, Is.EqualTo(rootPath.PathCombine("Users", "AxCrypt", "A Documents Folder", "My Extensionless File.axx")), "Conversion of file name without extension to encrypted form.");
        ...
        public static void TestExtensions_UserAsymmetricKeysToAccountKeyAndBack(CryptoImplementation cryptoImplementation)
        {
            ...
            UserKeyPair originalKeys = new UserKeyPair(EmailAddress.Parse("support@axcrypt.net"), 512);
