...
namespace AxCrypt.Core.Test
{
    ...
    public class TestIdentityPublicTag
    {
        ...
        {
            UserKeyPair key1 = new UserKeyPair(EmailAddress.Parse("testuser1@axcrypt.net"), 512);
            UserKeyPair key2 = new UserKeyPair(EmailAddress.Parse("testuser2@axcrypt.net"), 512);
