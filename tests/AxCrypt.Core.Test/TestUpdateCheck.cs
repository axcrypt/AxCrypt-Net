...
namespace AxCrypt.Core.Test
{
    ...
    public static class TestUpdateCheck
    {
        ...
        public static async Task TestVersionUpdated()
        {
            ...
            Uri updateWebPageUrl = new Uri("https://axcrypt.net/");
        ...
        public static async Task TestVersionUpdatedWithInvalidVersionFormatFromServer()
        {
            ...
            Assert.That(eventArgs.DownloadVersion.Url, Is.EqualTo(new Uri("https://axcrypt.net/")), "The right URL should be passed in the event args.");
